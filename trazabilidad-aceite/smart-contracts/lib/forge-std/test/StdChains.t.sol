...
contract StdChainsTest is Test {
    function test_ChainRpcInitialization() public {
        ...
        assertEq(getChain(91633).rpcUrl, "http://127.0.0.1:8558");
    ...
    function test_RevertIf_SetChain_ChainIdExist_FirstTest() public {
        ...
        vm.expectRevert("StdChains setChain(string,ChainData): Chain ID 91633 already used by \"anvil\".");
        stdChainsMock.exposed_setChain("anvil2", ChainData("Anvil", 91633, "URL"));
    }
    ...
    function test_RevertIf_DontUseDefaultRpcUrl() public {
        ...
        vm.expectRevert();
        stdChainsMock.exposed_getChain(91633);
        vm.expectRevert();
